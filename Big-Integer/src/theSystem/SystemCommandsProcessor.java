...
public class SystemCommandsProcessor extends CommandProcessor { 
	...
	public SystemCommandsProcessor() {
		...
		////////////////////////////////////////////////////////////////////////////
		add(GENERALSTATE, SystemCommand.getFLSC("var name", new VarProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("delete name", new DeleteProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("load name", new LoadProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("save name", new SaveProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("show name", new ShowProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("add name int int", new AddProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("sub name int int", new SubProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("mult name int int", new MultProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("factorial name int", new FactorialProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("factors int", new FactorsProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("prime int", new PrimeProcessor()));
	...
	private class ShowListsProcessor implements CommandActionHandler {
		public ArrayList<String> execute(Command c) {
			// command has no operand nothing
			//is needed from the
