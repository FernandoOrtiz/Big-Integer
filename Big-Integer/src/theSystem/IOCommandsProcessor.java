...
import processorClasses.AddProcessor;
import processorClasses.DeleteProcessor;
import processorClasses.FactorialProcessor;
import processorClasses.FactorsProcessor;
import processorClasses.LoadProcessor;
import processorClasses.MultProcessor;
import processorClasses.PrimeProcessor;
import processorClasses.SaveProcessor;
import processorClasses.ShowProcessor;
import processorClasses.SubProcessor;
import processorClasses.VarProcessor;
...
public class IOCommandsProcessor extends CommandProcessor {
	...
	public IOCommandsProcessor() { 		
		...
		add(GENERALSTATE, SystemCommand.getFLSC("var var_name", new VarProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("delete var_name", new DeleteProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("load file_name", new LoadProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("save file_name", new SaveProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("show var_name", new ShowProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("add value value", new AddProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("sub value value", new SubProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("mult value value", new MultProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("factorial value", new FactorialProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("factors value", new FactorsProcessor()));
		add(GENERALSTATE, SystemCommand.getFLSC("prime value", new PrimeProcessor()));
